...
func TestNewConnectionManagerDB(t *testing.T) {
	// 创建临时 SQLite 存储用于测试
	tmpDB := "test_conn_mgr_db.db"
	...
	cm, err := NewConnectionManagerDB(testStorage)
	if err != nil {
...
func TestConnectionManagerDB_AddConnection(t *testing.T) {
	tmpDB := "test_add_conn.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_AddConnection_InvalidType(t *testing.T) {
	tmpDB := "test_add_invalid.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_GetAllConnections(t *testing.T) {
...
func TestConnectionManagerDB_GetConnection_NotExists(t *testing.T) {
	tmpDB := "test_get_not_exists.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_SwitchConnection(t *testing.T) {
	tmpDB := "test_switch.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_SwitchConnection_NotExists(t *testing.T) {
	tmpDB := "test_switch_not_exists.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_GetActiveConnection_NoActive(t *testing.T) {
	tmpDB := "test_no_active.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_RemoveConnection(t *testing.T) {
	tmpDB := "test_remove.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_RemoveConnection_NotExists(t *testing.T) {
	tmpDB := "test_remove_not_exists.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_UpdateConnection(t *testing.T) {
	tmpDB := "test_update.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_UpdateConnection_NotExists(t *testing.T) {
	tmpDB := "test_update_not_exists.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_Reconnect(t *testing.T) {
	tmpDB := "test_reconnect.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_Reconnect_NotExists(t *testing.T) {
	tmpDB := "test_reconnect_not_exists.db"
	defer os.Remove(tmpDB)
...
func TestConnectionManagerDB_LoadConnections(t *testing.T) {
	tmpDB := "test_load_connections.db"
	defer os.Remove(tmpDB)
	...
	// LoadConnections 在 NewConnectionManagerDB 时已经调用
	// 这里测试空数据库的情况
	connections := cm.GetAllConnections()
	if connections == nil {
		t.Error("期望返回连接列表，但返回 nil")
...
func TestConnectionManagerDB_MultipleConnections(t *testing.T) {
	tmpDB := "test_multiple.db"
	defer os.Remove(tmpDB)
